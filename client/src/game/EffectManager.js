...
export class EffectManager {
  ...
  async preload() {
    ...
    const [
      ...
      // 블링크·힐 추가
      load(`${BASE_MAGIC}/8.png`),   // 초록 풀 솟아오름 → 힐
      load(`${BASE_MAGIC}/10.png`),  // 보라 구체 펑 → 블링크
      // Free 팩
    ...
    this.strips.green_ground = mkStrip(m8,   8);  // 초록 풀 솟아오름 (힐)
    this.strips.magic_pop    = mkStrip(m10,  6);  // 보라 구체 펑 (블링크)
